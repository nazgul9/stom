    ...
    return (
        ...
        <Container>
            <Row className='mt-5'>
                ...
                Получите здоровую и белоснежную улыбку
                </p>
                
                <Card.Text style={{ color: "white", fontSize: "20px" }}>
                    Превратите её в свою визитную карточку, как это уже сделали многие звёзды, певцы, спортсмены, политики и предприниматели
                </Card.Text>
                ...
                <Row className='mt-5'>
                    ...
                    <Col md={6} xs={10} style={{ color: "white", fontSize: "20px" }}>
                            ...
                            <p className='textdoctor'>
                                     Я стоматолог-ортопед, основатель и главный врач клиники «Dr. Aidarov». Каждый пациент является для нас VIP-персоной, поэтому мы предоставляем только лучшее из мира стоматологии
                            </p>
                            <p className='textdoctor'>
                                    Всегда стремлюсь быть в авангарде современной стоматологии.
                                    Стоматология - сфера чрезвычайно высокотехнологичная, поэтому динамика ее развитие превышает динамику большинства остальных сфер деятельности.
                                    И большую часть моей жизни занимает обучение, прохождение курсов и посещение конференций.
                            </p>
                            <p className='textdoctor'>
                                    Мы работаем с современными технологиями, которые позволяют не только быстро и качественно создать и оценить результат, но и визуализировать процесс для пациента без боли и мучительных процедур. 
                ...
                <Row className="mt-5">
                    <Col xs={10} md={4} className='mt-5' >
                        <div className='justify-content-evenly text-center  ' >
                            <img class=" t013__img t-img" src={aidarov4} imgfield="img" data-tu-max-width="320" data-tu-max-height="320" data-tu-cover="c" alt="" role="presentation">
                            </img>
                                    ...
                                    return(
                                        <>
                                         <Accordion.Item eventKey={e.key} style={{backgroundColor:"black", color:"#d3bb7e"}}>
                                            <Accordion.Header style={{backgroundColor:"black", color:"#d3bb7e"}}>{e.title}</Accordion.Header>
                ...
                <Col md={10} xs={10} className='mt-5'>
                   ...
                   <Row>
                    <Col md={6} xs={10}>
                     ...
                     Наши пациенты как будто попадают в будущее. Мы можем полностью визуализировать всё для пациентов: на специальных мониторах показать зубы в разных проекциях, в разрезе, можем сделать подробный полный чекап всей зубочелюстной системы. И всё это без временных затрат и с максимальным комфортом.
                     <p>
                     Мы живём жизнью пациентов, их клиническими случаями. Бывает, что рабочий день начинается в 10 утра, а заканчивается в 4 утра уже следующего дня. Поэтому у нас в клинике есть спальные места, душевые кабины, большая оборудованная кухня, плейстейшен, домашний кинотеатр — все условия, чтобы при необходимости отдохнуть в клинике и принять каждого пациента.
                    </p>
                    </h5> 
                    </Col>
                   <Col md={6} xs={10}>
